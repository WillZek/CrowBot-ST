...
const translations = {
    ...
    example: 'مثال',
    stickMsg: 'من فضلك أرسل صورة أو فيديو لصنع ملصق',
    ...
    connID: '❀ مرحبًا بكم في مجتمعنا⍴⍴، لدينا كتالوج ضخم من مقاطع الفيديو لتختار من بينها *#delsesion* وسنرسل إليك جميع *#code*.\n\n> ${dev}',
    connMsg: 'في المرة القادمة التي تقوم فيها بالاتصال، قم بإرسال الرسالة التالية لتسجيل الدخول بدون مسح رمز *QR* آخر',
    botlist: 'الروبوتات الفرعية النشطة',
    sinsb: 'لا يوجد روبوتات فرعية نشطة في هذا الوقت',
