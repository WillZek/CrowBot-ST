...
if (!m.quoted.text.includes("Y O U T U B E")) return conn.reply(m.chat, `Responde al resultado de YouTube Play.`, m, rcanal).then(_ => m.react('✖️'))
...
handler.customPrefix = /^(Mp4|mp4|vídeo|Vídeo|video|Video)/
