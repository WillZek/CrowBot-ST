...
if (!text) return conn.reply(message.chat, '*Ingrese EL Nombre De Un Vídeo*', message, rcanal)
...
footer: proto.Message.InteractiveMessage.Footer.create({ text: '🔎 Play - Video' }),
...
handler.help = ['playvid <texto>']
handler.estrellas = 1
handler.register = true
handler.tags = ['buscador']
handler.command = ['playvid', 'tts3', 'tiktoks3']
