...
let biografia = await conn.fetchStatus('50557865603' +'@s.whatsapp.net').catch(_ => 'Sin Biografía')
...
[`${nomorown}`, `👑 Propietario`, `🌸 ianalejandrook15x`, dev, correo, `Argentina ☁`, `${yt}`, bio],
