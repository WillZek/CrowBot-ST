...
await conn.sendMessage(m.chat, {video: {url: gifUrl}, gifPlayback: true, caption: text.trim(), mentions: [m.sender]}, "mediaUrl": global.channel, "title": packname, body: dev, "sourceUrl": global.channel, {quoted: m});
